...
public class RegistrationActivity {
	...
	public static void registrationActivityPage(WebDriver driver) throws Exception {
		...
		/** Input address Tab */
		String[] dataFormAddressTab = {"Warrent 123", "philadelphia", "19029", "2025551086"};
		...
		select = new Select(driver.findElement(By.id("wu_register_state")));
